...
public class OpenApiConfigConstants {
    public static final String OPENAPI_INFO_TITLE = "CNAB Parser Pro";
    public static final String OPENAPI_INFO_VERSION = "0.0.1";
    public static final String OPENAPI_INFO_DESCRIPTION = "API for CNAB file parser";
    ...
    public static final String OPENAPI_EXTERNAL_DOCS_URL = "https://github.com/souluanf/cnab-parser-pro";
}
